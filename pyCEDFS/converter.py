...
This script provides utils to convert the CFS file to other formats.

In part the CFS converter is adapated from IPFX's: ABFconverter: https://github.com/AllenInstitute/ipfx
...
class CFSConverter:
    ...
    def __init__(self, inFileOrFolder, outFile, compression=True):
        """
